        ...
        items: <BottomNavigationBarItem>[
          BottomNavigationBarItem(
            icon: _selectedIndex == 0
                ? new SvgPicture.asset('assets/svg/icon_home_colored.svg',color: Colors.orange,)
                : new SvgPicture.asset('assets/svg/icon_home.svg'),
            label: 'Home',
          ),
          BottomNavigationBarItem(
            icon: _selectedIndex == 1
                ? new SvgPicture.asset('assets/svg/icon_heart_colored.svg',color: Colors.orange,)
                : new SvgPicture.asset('assets/svg/icon_heart.svg',),
            label: 'Heart',
          ),
          BottomNavigationBarItem(
            icon: _selectedIndex == 2
                ? new SvgPicture.asset('assets/svg/icon_plus_colored.svg',color: Colors.orange,)
          ...
          BottomNavigationBarItem(
            icon: _selectedIndex == 3
                ? new SvgPicture.asset(
                    'assets/svg/icon_notification_colored.svg',color: Colors.orange,)
                : new SvgPicture.asset('assets/svg/icon_notification.svg',),
            label:'Notification',
          ),
          BottomNavigationBarItem(
            icon: _selectedIndex == 4
                ? new SvgPicture.asset('assets/svg/icon_user_colored.svg',color: Colors.orange,)
